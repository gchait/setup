...
APT_PKGS="
  ...
  docker-buildx docker-compose docker.io eza fd-find figlet gh glab golang-go gron helm htop
  hugo iproute2 iptables jq just kubectl less libasound2-dev libasound2t64 libatk1.0-0t64
  libcups2t64 libgbm1 libgdk-pixbuf-2.0-dev libgtk-3-0t64 libgtk-3-dev libncurses6
  libnss3-dev libpango-1.0-0 libxcomposite1 libxcursor1 libxdamage1 libxext6 libxi6
