...
APT_PKGS="
  ...
  docker-buildx docker-compose-v2 docker.io eza fd-find figlet gh glab golang-go gron helm
  htop hugo iproute2 iptables jq just kubectl less libasound2-dev libasound2t64 libatk1.0-0t64
  libcups2t64 libgbm1 libgdk-pixbuf-2.0-dev libgtk-3-0t64 libgtk-3-dev libncurses6 libnss3-dev
  libpango-1.0-0 libxcomposite1 libxcursor1 libxdamage1 libxext6 libxi6 libxrandr2 libxss-dev
  libxss1 libxtst6 lolcat make man-db maven moreutils nano ncat nodejs npm openssh-client
  openssl packer postgresql-client python-is-python3 python3-dev python3-pip ripgrep shellcheck
  shfmt symlinks tar tcpdump terraform tree tshark unzip vim wget whois x11-xserver-utils zip zsh
"
