...
APT_PKGS="
  adwaita-icon-theme asciinema bat bind9-dnsutils build-essential claude-code cmatrix docker-buildx
  docker-compose-v2 docker.io eza fd-find figlet gh glab golang-go gron helm htop hugo iproute2
  iptables jq just kubectl less libasound2-dev libasound2t64 libatk1.0-0t64 libcups2t64
  ...
  lolcat make man-db maven moreutils nano ncat nodejs npm openssh-client openssl packer
  postgresql-client python-is-python3 python3-dev python3-pip python3-setuptools ripgrep shellcheck
